(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.wasm_mergesort_example = {}));
    ...
    */
    function mergesort(vec) {
        try {
            ...
            wasm.mergesort(retptr, ptr0, len0);
    ...
    */
    ...
    async function __wbg_init(input) {
        ...
        if (typeof input === 'undefined') {
            input = new URL('wasm_mergesort_example_bg.wasm', "");
        }
